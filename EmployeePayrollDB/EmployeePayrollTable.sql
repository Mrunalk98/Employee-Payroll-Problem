...
Payroll_ID int FOREIGN KEY REFERENCES payroll(Payroll_ID),
);
...
insert into company values('Capgemini');
insert into company values('TCS');

insert into payroll values(2000, 200, 50, '2020-03-01');
insert into payroll values(4000, 250, 100, '2020-02-01');
insert into payroll values(3000, 150, 70, '2020-05-01');

insert into employee values('Mrunal', '8596515265', 'LA', 'F', 1, 2);
insert into employee values('John', '9999515265', 'SA', 'M', 2, 1);
insert into employee values('Sam', '8899515265', 'LA', 'F', 1, 3);
...
-- UC 12
select Emp_ID, Emp_Name, Emp_Phone, Emp_Address, Emp_Gender, Emp_Phone, BasicPay, Deductions, TaxablePay, IncomeTax, NetPay
from employee inner join payroll
on employee.Payroll_ID = payroll.Payroll_ID;

select * from payroll where Payroll_ID = (select Payroll_ID from employee where Emp_Name='Mrunal');
